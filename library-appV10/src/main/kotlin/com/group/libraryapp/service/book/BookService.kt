...
class BookService constructor(
        ...
        private val userLoandHistoryQuerydslRepository: UserLoanHistoryQuerydslRepository,
    ...
    fun loanBook(request: BookLoanRequest) {
        ...
        if (userLoandHistoryQuerydslRepository.find(request.bookName, UserLoanStatus.LOANED) != null) {
    ...
    fun countLoanbook(): Int {
        return userLoandHistoryQuerydslRepository.count(UserLoanStatus.LOANED).toInt()
